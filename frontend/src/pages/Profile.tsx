    ...
    const loadProfile = async () => {
      ...
      try {
        ...
        const [userBasicInfo, survey] = await Promise.all([
          getUserBasicInfo(currentUser.uid),
          getUserSurvey(currentUser.uid),
        ]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        {/* Call to Action */}
        <div className="mt-8 bg-gradient-to-r from-red-600 to-red-700 rounded-2xl shadow-xl overflow-hidden">
          <div className="px-6 py-12 text-center">
            <h2 className="text-2xl font-bold text-white mb-4">
              Ready to find your perfect match?
            </h2>
            <p className="text-red-100 mb-6 max-w-2xl mx-auto">
              Complete your profile and start connecting with other Cornell
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                ...
                className="bg-white/0 hover:bg-white/10 border-2 border-white text-white px-8 py-3 rounded-xl font-semibold text-lg transition-all"
              >
                View Matches
              </button>
            </div>
